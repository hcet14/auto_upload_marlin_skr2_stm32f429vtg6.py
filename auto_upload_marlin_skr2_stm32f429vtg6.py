...
if pioutil.is_pio_build():
	...
	def before_upload(source, target, env):
		...
		#change permissions of SDcard
		os.chown -hR(path_sdcard, 1000, 1000)
		#os.chown -hR hcet path_sdcard
		#sudo chmod -R 777 path_sdcard
		#udo mount --options remount,rw path_sdcard
